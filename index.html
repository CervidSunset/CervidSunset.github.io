              ...
              if (!this.activeDOM.has(key) && key !== '0,0') {
                ...
                if (tileType === 'water') {
                  tileEl.innerHTML = `<a-plane rotation="-90 0 0" width="4" height="4" color="#1CA3EC" material="opacity: 0.8"></a-plane>
                                      ...
                                      <a-plane position="0 5 0" rotation="90 0 0" width="4" height="4" color="#F0F8FF" material="roughness: 0.2"></a-plane>`;
                  ...
                  tileEl.innerHTML = `<a-plane rotation="-90 0 0" width="4" height="4" color="#1CA3EC" material="opacity: 0.8"></a-plane>
                                      <a-box position="0 1.5 0" width="0.8" height="5" depth="0.8" color="#FFFFFF"></a-box>
                                      <a-plane position="0 5 0" rotation="90 0 0" width="4" height="4" color="#F0F8FF" material="roughness: 0.2"></a-plane>`;
                } else if (tileType === 'wall') {
                  tileEl.innerHTML = `<a-plane rotation="-90 0 0" width="4" height="4" color="#F0F8FF"></a-plane>
                                      <a-box position="0 2 -1.9" width="4" height="5" depth="0.2" color="#FFFFFF"></a-box>
                                      <a-plane position="0 5 0" rotation="90 0 0" width="4" height="4" color="#F0F8FF" material="roughness: 0.2"></a-plane>`;
                }
